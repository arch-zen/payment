 ...
 *
 */
public class CmbAggrementCancelRequest extends CmbDTO {
     ...
     * @return the reqData
     */
    public AggrementCancelReqData getReqData() {
        return reqData;
    }
     ...
     */
    public void setReqData(AggrementCancelReqData reqData) {
        this.reqData = reqData;
    }

    private AggrementCancelReqData reqData = new AggrementCancelReqData();

    public class AggrementCancelReqData {
        public AggrementCancelReqData() {
