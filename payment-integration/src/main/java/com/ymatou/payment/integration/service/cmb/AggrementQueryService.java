 ...
 */
@Component
public class AggrementQueryService implements InitializingBean {
    private CloseableHttpClient httpClient;

    @Autowired
    private IntegrationConfig integrationConfig;

    public CmbAggrementQueryResponse doService(CmbAggrementQueryRequest request, HashMap<String, String> header)
            throws Exception {
        ...
        CmbAggrementQueryResponse response = JSON.parseObject(resp, CmbAggrementQueryResponse.class);

        return response;
    }

    private List<NameValuePair> getRequestBody(CmbAggrementQueryRequest req) {
